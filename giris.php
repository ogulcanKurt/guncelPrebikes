  ...
  <header class="headerSabitle headersifir">
    <div class="row">
      ...
      <div class="col-lg-1 yukariBosluk">
        <div class="account">
          <img class="userPng siyahUser" src="assets/icons/userSiyah.png" alt="user">
            ...
            <div class="girisFormu">
              ...
              <div class="formBaslik">
                <ul class="formOrtalaGiris">
                  <li><button class="odemeAdimlari butonBorder girisButonu">Giriş </button></li>
                  <li class="odemeSaga"><a class="kayitButonu" href="kayit1.php">Kayıt Ol</a></li>
                </ul>
              </div>
              <form action="hesapBilgisi.php" class="formicerik">

                <!-- E Mail -->
                <div class="form-outline mb-4">
                  <label class="form-label yildizBefore yaziAyar" for="form6Example3">E-Posta:</label>
                  <input placeholder="E-Posta..." type="text" id="form6Example3" class="form-control yeniFormGenel" />
                </div>

                <!-- Şifre -->
                <div class="form-outline mb-4">
                  <label class="form-label yildizBefore yaziAyar" for="form6Example3">Şifre:</label>
                  <input placeholder="Şifre..." type="text" id="form6Example3" class="form-control yeniFormGenel" />
                </div>
                ...
                <div class="form-check mb-4 opsiyonYukari">
                  <div class="radioinputs">
                    ...
                    <label class="form-check-label" id="sifreRadio" for="form6Example8">Beni Hatırla</label>
                  </div>
                </div>
                ...
                <div class="form-check mb-4 opsiyonYukari">
                  <div class="radioinputs">
                    <input class="form-check-input me-2 radioinput3" type="radio" value="" id="form6Example8" checked />
                    <label class="form-check-label" id="sifreRadio" for="form6Example8">Kampanyalardan haberdar olmak istiyorum.</label>
                  </div>
                </div>
                ...
                <div class="row mb-4">
                  <div class="col">
                    <div class="form-outline">
                      <input class="formGonder form-control yeniFormGenel butonGonder" type="submit" id="form6Example1" value="Giriş" />
                    </div>
                  </div>
                </div>
