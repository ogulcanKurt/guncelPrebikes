          ...
          <div class="odemeKismi">
            ...
            <div class="kayitFormu2">
              ...
              <div class="asamaSayi">
                ...
                <div class="sayiAktif sayiArala">2</div>
                <div class="sayiArala">3</div>
              </div>
              <div class="formBaslik">
                <ul class="formOrtalaGiris">
                  <li><a class="kayitButonu" href="giris.php">Giriş</a></li>
                  <li class="odemeSaga"><button class="odemeAdimlari butonBorder girisButonu"><a href="kayit1.php">Kayıt Ol</a></button></li>
                </ul>
              </div>
              <div class="oncekiSayfa">
                <span class="isaretKucuk">
                  </span>
                    <a href="kayit1.php"><span class="sayfaAralik sayfaGeriBilgi">Hesap Bilgileri</span></a>
              </div>
              <span id="hesapYazi"><b>Fatura Bilgileri</b></span>
              <form action="kayit3.php" class="kayitFormicerik2">
                ...
                <div class="form-outline mb-4">
                  ...
                  <input placeholder="Ülke..." type="text" id="form6Example3" class="form-control yeniFormGenel" />
                </div>
                ...
                <div class="form-check mb-4 opsiyonYukari">
                  <div class="radioinputs">
                    ...
                    <label class="form-check-label" id="sifreRadio" for="form6Example8">Bu adrese gönder</label>
                  </div>
                </div>
                <!-- Checkbox -->
                <div class="form-check mb-4 opsiyonYukari">
                  <div class="radioinputs">
                    <input class="form-check-input me-2 radioinput3" type="radio" value="" id="form6Example8" checked />
                    <label class="form-check-label" id="sifreRadio" for="form6Example8">Farklı bir adrese gönder</label>
                  </div>
                </div>
                ...
                <div class="row mt-4">
                  <div class="col">
                    <div class="form-outline">
                      <input class="formGonder form-control yeniFormGenel butonGonder" type="submit" id="form6Example1" value="İlerle" />
                    </div>
                  </div>
                </div>
