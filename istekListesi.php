                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 filigranSinirla">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="istekListesi">
                                            <div class="istekDetaylari">
                                                <div class="kaydetikon">
                                                    <i class="fas fa-bookmark"></i>
                                                </div>
                                                <div class="istekGorseli">
                                                    <img src="assets/images/bisikletler/istekBk.png" alt="">
                                                </div>
                                                <div class="istekBilgileri">
                                                    <ul class="dashboardMenu">
                                                        <div class="baslikAyarla">
                                                            <h3>Liv Vall E+ 2</h3>
                                                            <span id="kisaDetay">Elektrische Fiets 10V Echeveria</span>
                                                        </div>
                                                        <div class="listeAyarla">
                                                            <li class="istekList"><a href="#">Zadel: Liv Sport</a></li>
                                                            <li class="istekList"><a href="#">Shifters: Shimano Deore</a></li>
                                                            <li class="istekList"><a href="#">Slot: - Spaken: Stainless steel</a></li>
                                                        </div>
                                                    </ul>
                                                </div>
                                                <div class="sepetikonu">
                                    ...
                                    <div class="asagiKaydirikon">
                                        <img src="assets/icons/asagi.png" alt="">
                                    </div>
                                     <div class="hepsiniEkle">
                                        <button class="hepsiButon">Hepsini Sepete Ekle</button>
