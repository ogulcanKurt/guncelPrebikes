                ...
                <div class="col-lg-12">
                    <div class="odemeKismi">
                        ...
                        <div class="kayitFormu">
                                ...
                                <div class="asamaSayi">
                                    <div class="sayiAktif sayiArala">1</div>
                                ...
                                <div class="formBaslik">
                                    <ul class="formOrtalaGiris">
                                        ...
                                        <li class="odemeSaga"><a href="kayit1.php"><button class="odemeAdimlari butonBorder girisButonu">Kayıt Ol</button></a></li>
                                    </ul>
                                </div>
                                <span id="hesapYazi"><b>Hesap Bilgileri</b></span>
                            <form action="kayit2.php" class="kayitFormicerik">
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <div class="form-outline">
                                            <a href="kayit2.php"><input class="formGonder form-control yeniFormGenel butonGonder" type="submit" id="form6Example1" value="İlerle" /></a>
                                        </div>
                                    </div>
                                </div>
